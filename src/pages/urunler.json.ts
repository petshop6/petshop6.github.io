...
export const GET: APIRoute = async () => {
  const liste = await Promise.all(urunler.map(async (u) => {
    ...
    return { slug: u.slug, ad: u.ad, marka: u.marka, tur: u.tur, kategori: u.kategori, etiketler: u.etiketler, baslangic: u.baslangic, stok: u.stok, kampanya: u.kampanya, gorsel: img.src };
  }));
